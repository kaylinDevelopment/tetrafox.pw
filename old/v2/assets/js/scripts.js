// videos
var videos = ["https://www.youtube.com/embed/G7n-WrYo3-U?autoplay=1",
    ...
    "https://www.youtube.com/embed/Ry5URU-Py2Q?autoplay=1",
    "https://www.youtube.com/embed/9sxgbpTeiWQ?autoplay=1",
    "https://www.youtube.com/embed/ElC7e3sFSyM?autoplay=1",
    "https://www.youtube.com/embed/50k6Q8xNSkU?autoplay=1",
    "https://www.youtube.com/embed/aRsWk4JZa5k?autoplay=1",
...
function getVideo() {
    ...
    if (!seenVideos.includes(video) && seenVideos.length !== videos.length - 1) {
        seenVideos.push(video);
        return video;
    } else if (seenVideos.length === videos.length - 1) {
        seenVideos = [];
        return video;
    } else {
        getVideo();
